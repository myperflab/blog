! function(i) {
    ...
    t.prototype = {
        run: function() {
            ...
            }), s.$about.click(function(t) {
                t.preventDefault(), s.playBack()
            }), s.$aboutCard.click(function(t) {
                t.stopPropagation()
            })
        },
        play: function() {
            var t = this;
            t.$blog.fadeOut(), t.$about.fadeIn(), setTimeout(function() {
                t.dropAboutCard()
            }, 300)
        },
        playBack: function() {
...
function(s) {
    ...
    t.prototype = {
        ...
        showResult: function(t) {
            -1 === t ? this.$archiveResult.html("").hide() : (0 === t ? this.$archiveResult.html(this.messages.zero) : 1 === t ? this.$archiveResult.html(this.messages.one) : this.$archiveResult.html(this.messages.other.replace(/\{n\}/, t))).show()
        },
...
function(o) {
    ...
    t.prototype = {
        ...
        showPosts: function(t) {
            var s = this,
                e = s.categories + "[data-" + s.dataCategory + "*='" + t + "']",
                i = s.posts + "[data-" + s.dataCategory + "*='" + t + "']";
            0 < s.countCategories(t) && o(e + "[data-" + s.dataParentCategories + "]").length && o(e).each(function() {
                o(this).attr("data-" + s.dataParentCategories).split(",").forEach(function(t) {
                    t = "[data-" + s.dataCategory + "='" + t + "']";
                    o(s.categories + t).show(), o(s.posts + t).show(), o(s.posts + t + " > .archive-posts > .archive-post").hide()
                })
            }), o(e).show(), o(i).show(), o(i + " > .archive-posts > .archive-post").show()
        },
        showAll: function() {
...
function(i) {
    ...
    t.prototype = {
        run: function() {
            var t = this;
            t.resize(), i(window).smartresize(function() {
                t.resize()
            })
        },
        resize: function() {
            this.$codeBlocks.each(function() {
                var t = i(this).find(".gutter"),
                    s = i(this).find(".code"),
                    e = s.width() - s.innerWidth(),
                    e = i(this).outerWidth() - t.outerWidth() + e;
                s.css("width", e), s.children("pre").css("width", e)
            })
        }
    }, i(document).ready(function() {
        i.fn.hasHorizontalScrollBar = function() {
...
function(s) {
    ...
    s(document).ready(function() {
        function t() {
            var t = !1;
            480 < s(window).height() && (t = !0), s(".fancybox").fancybox({
                buttons: ["fullScreen", "thumbs", "share", "download", "zoom", "close"],
                thumbs: {
                    autoStart: t,
                    axis: "x"
                }
        ...
        t(), s(window).smartresize(function() {
            t()
        })
    })
}(jQuery),
function(e) {
    ...
    function t() {
        this.$header = e("#header"), this.headerHeight = this.$header.height(), this.headerUpCSSClass = "header-up", this.delta = 15, this.lastScrollTop = 0
    }
    t.prototype = {
        run: function() {
            var t, s = this;
...
function(n) {
    ...
    s.prototype = {
        ...
        var t;
        n(".image-gallery").length && (t = new s, setTimeout(function() {
            t.run()
        }, 500))
    })
}(jQuery),
function(e) {
    ...
    function t() {
        this.$postBottomBar = e(".post-bottom-bar"), this.$postFooter = e(".post-actions-wrap"), this.$header = e("#header"), this.delta = 15, this.lastScrollTop = 0, this.lastScrollDownPos = 0, this.lastScrollUpPos = 0
    }
    t.prototype = {
        run: function() {
            var t, s = this;
        ...
        swipePostBottomBar: function() {
            ...
            this.lastScrollTop > t && Math.abs(this.lastScrollDownPos - t) > this.delta && (s + this.$postFooter.height() > t + e(window).height() || s < t + this.$header.height()) && (this.$postBottomBar.slideDown(), this.lastScrollUpPos = t), t > this.lastScrollUpPos + this.delta && (this.$postBottomBar.slideUp(), this.lastScrollDownPos = t), this.lastScrollTop = t
        }
    }, e(document).ready(function() {
...
function(t) {
    ...
    function s() {
        this.$sidebar = t("#sidebar"), this.$openBtn = t("#btn-open-sidebar"), this.$closeBtn = t("#header, #main, .post-header-cover"), this.$header = t("#header"), this.$headerElements = {
        ...
        }, this.$blog = t(".post-bottom-bar, #main, .post-header-cover, .post, #bottom-bar .post-action-share").add(this.$header).add(this.$headerElements.title).add(this.$headerElements.rightPicture), this.$body = t("body"), this.mediumScreenWidth = 768
    }
    s.prototype = {
        run: function() {
            var e = this;
            this.$openBtn.click(function() {
                e.$sidebar.hasClass("pushed") || e.openSidebar()
            }), this.$closeBtn.click(function() {
                e.$sidebar.hasClass("pushed") && e.closeSidebar()
            });
            var i = null,
                o = null;
            t(document).on("touchstart", function(t) {
                e.$sidebar.hasClass("pushed") && (t = (t.touches || t.originalEvent.touches)[0], i = t.clientX, o = t.clientY)
            }).on("touchmove", function(t) {
                var s;
                i && o && e.$sidebar.hasClass("pushed") && (s = t.touches[0].clientX, t = t.touches[0].clientY, s = i - s, t = o - t, Math.abs(s) > Math.abs(t) && 0 < s && e.closeSidebar(), o = i = null)
            }), t(window).resize(function() {
                t(window).width() > e.mediumScreenWidth ? (e.resetSidebarPosition(), e.resetBlogPosition()) : e.closeSidebar()
            })
        },
        ...
        swipeSidebarToLeft: function() {
            var t = this;
            this.$sidebar.hasClass("pushed") && !this.$sidebar.hasClass("processing") && (this.$sidebar.addClass("processing").removeClass("pushed processing"), setTimeout(function() {
                t.$body.css("overflow-x", "auto")
            }, 255))
        },
        swipeBlogToRight: function() {
            var t = this.$blog;
            (t = this.$header.width() - this.$sidebar.width() - this.$headerElements.titleLink.width() < 130 ? t.not(this.$headerElements.title).not(this.$headerElements.rightPicture) : t).hasClass("pushed") || t.hasClass("processing") || (t.addClass("processing pushed"), setTimeout(function() {
